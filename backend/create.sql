...
create table tb_product (id int8 generated by default as identity, created_at TIMESTAMP WITHOUT TIME ZONE, date TIMESTAMP WITHOUT TIME ZONE, description TEXT, img_url varchar(255), name varchar(255), price float8, updated_at TIMESTAMP WITHOUT TIME ZONE, primary key (id));
